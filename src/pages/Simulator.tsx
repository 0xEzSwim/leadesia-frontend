      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-lg text-gray-600">
            Visualisez concrètement l'impact de Leadesia sur votre activité d'<strong>avocat indépendant</strong>. Ajustez les paramètres pour obtenir une projection personnalisée de votre croissance en nombre de dossiers et en montant des honoraires sur les 6 prochains mois.
          </p>
        </div>
