      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <button
                ...
                className="w-full sm:w-auto px-8 py-4 bg-brand-burgundy text-white rounded-sm font-medium text-lg shadow-lg hover:shadow-xl hover:bg-[#380c11] transition-all flex items-center justify-center gap-2"
              >
                Auditer mon potentiel
                <ArrowRight size={20} />
              </button>
              <a href="#expertise" className="w-full sm:w-auto px-8 py-4 bg-white border border-gray-200 text-gray-700 rounded-sm font-medium text-lg hover:bg-gray-50 transition-all flex items-center justify-center">
                Voir notre approche
              </a>
            </div>
          ...
          <div className="hidden lg:block lg:col-span-5 mt-12 lg:mt-0 relative">
            ...
            {/* Floating Card */}
            <div className="absolute -bottom-8 -left-8 bg-white p-5 rounded-lg shadow-xl border border-gray-100 max-w-xs">
              ...
              <p className="mt-3 text-sm text-gray-800 font-semibold">Dossiers signés via Leadesia</p>
            </div>
          </div>
        </div>
      </div>
